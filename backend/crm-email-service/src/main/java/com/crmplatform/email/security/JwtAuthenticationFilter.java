package com.crmplatform.email.security;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, 
        ...
        try {
            ...
            if (StringUtils.hasText(headerUserId) && StringUtils.hasText(headerRole)) {
                log.debug("Found user context headers - User: {}, Role: {}, UserId: {}, TenantId: {}", 
                ...
                log.debug("Successfully set authentication from headers for user: {}", headerUsername);
            } else {
    ...
    private boolean isPublicEndpoint(String requestURI, String method) {
        ...
        return requestURI.startsWith("/health") ||
               ...
               requestURI.equals("/api/email/welcome") ||
               requestURI.equals("/api/email/invitation");
    }
}
